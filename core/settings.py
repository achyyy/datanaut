...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure--a-q1h7#o!(4@(_0yzny%eh^-tsca4amvwn!98mw5-!v9dnibm')
...
MIDDLEWARE = [
    ...
    'studio.middleware.SessionCleanupMiddleware',
    'studio.middleware.SessionExpiryMiddleware',
